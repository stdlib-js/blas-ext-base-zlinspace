...
var zlinspace = tryRequire( resolve( __dirname, './../lib/zlinspace.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 6', opts, function test( t ) {
	t.strictEqual( zlinspace.length, 6, 'has expected arity' );
	t.end();
});
...
tape( 'the function fills a strided array', opts, function test( t ) {
	...
	zlinspace( x.length, new Complex128( 1.0, 2.0 ), new Complex128( 8.0, 16.0 ), true, x, 1 );
	...
	zlinspace( x.length, new Complex128( 1.0, 0.0 ), new Complex128( 3.0, 2.0 ), false, x, 1 );
	t.strictEqual( isSameComplex128Array( x, expected ), true, 'returns expected value' );
...
tape( 'if provided an `N` parameter equal to `1`, the function writes a single value to the input array', opts, function test( t ) {
	...
	zlinspace( 1, new Complex128( 1.0, 2.0 ), new Complex128( 3.0, 4.0 ), true, x, 1 );
	t.strictEqual( isSameComplex128Array( x, expected ), true, 'returns expected value' );
	...
	zlinspace( 1, new Complex128( 1.0, 2.0 ), new Complex128( 3.0, 4.0 ), false, x, 1 );
	t.strictEqual( isSameComplex128Array( x, expected ), true, 'returns expected value' );
...
tape( 'the function returns a reference to the input array', opts, function test( t ) {
	...
	out = zlinspace( x.length, new Complex128( 0.0, 0.0 ), new Complex128( 5.0, 5.0 ), false, x, 1 );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns the input array unchanged', opts, function test( t ) {
	...
	zlinspace( 0, new Complex128( 0.0, 0.0 ), new Complex128( 10.0, 10.0 ), true, x, 1 );
	t.strictEqual( isSameComplex128Array( x, expected ), true, 'returns expected value' );

	zlinspace( -4, new Complex128( 0.0, 0.0 ), new Complex128( 10.0, 10.0 ), true, x, 1 );
	t.strictEqual( isSameComplex128Array( x, expected ), true, 'returns expected value' );
...
tape( 'the function supports specifying a stride', opts, function test( t ) {
	...
	zlinspace( 3, new Complex128( 1.0, 0.0 ), new Complex128( 4.0, 3.0 ), false, x, 2 );
	t.strictEqual( isSameComplex128Array( x, expected ), true, 'returns expected value' );
	t.end();
});
...
tape( 'the function supports specifying a negative stride', opts, function test( t ) {
	...
	zlinspace( 3, new Complex128( 1.0, 0.0 ), new Complex128( 3.0, 2.0 ), true, x, -2 );
	t.strictEqual( isSameComplex128Array( x, expected ), true, 'returns expected value' );
	t.end();
});
...
tape( 'the function supports view offsets', opts, function test( t ) {
	...
	zlinspace( 2, new Complex128( 0.0, 0.0 ), new Complex128( 10.0, 10.0 ), true, x1, 2 );
